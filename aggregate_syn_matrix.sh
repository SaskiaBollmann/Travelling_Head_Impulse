...
if [ -z "$IDENTIFIER" ]; then
    echo "Usage: ./aggregate_syn_matrix.sh <identifier> [suffix]"
    exit 1
fi
...
MATRIX_FILE="${OUT_DIR}/correlation_matrix_SyN_${OUT_ID}.txt"
...
echo "Aggregating matrix for $OUT_ID..."
...
echo "Matrix built at: $MATRIX_FILE"
